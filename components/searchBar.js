    ...
    <div className="bg-white-400  border-[1px] rounded-lg border-slate-200 p-3 mb-4">
      <div className="flex justify-center items-center mb-2">
        <input
          ...
          id="search"
          name="search"
          className="w-full py-1 rounded-full bg-gray-100 border border-gray-200 placeholder-gray-500 text-xs focus:outline-none focus:border-gray-400 focus:bg-white px-3 mr-1"
        ...
        <input
          ...
          name="search"
          className="w-full py-1 rounded-full bg-gray-100 border border-gray-200 placeholder-gray-500 text-xs focus:outline-none focus:border-gray-400 focus:bg-white px-3 mr-1"
          placeholder="Search by name, genre, year....."
        />
